<html>
    ...
    <body>
        ...
        <div class="display-container" align="center">
            <img class="mySlides" src="images/picquizz1.jpg" style="width:50%" border="5">
            <img class="mySlides" src="images/picquizz2.jpg" style="width:50%" border="5">
            <img class="mySlides" src="images/picquizz3.jpg" style="width:50%" border="5">
            <img class="mySlides" src="images/picquizz4.jpg" style="width:50%" border="5">
